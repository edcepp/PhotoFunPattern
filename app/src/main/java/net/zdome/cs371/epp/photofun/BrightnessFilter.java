...
public class BrightnessFilter extends PhotoFilter {
    ...
    /*
    * tranformPixel This method overrides the transformPixel in the parent class. It adds 100 to
    * each RGB color component. The maxium value of each component is limited to 255
    *
