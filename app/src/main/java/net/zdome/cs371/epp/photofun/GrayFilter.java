...
public class GrayFilter extends PhotoFilter {
    ...
    /*
    * tranformPixel This method overrides the transformPixel in the parent class. It transforms
    * a color pixel to gray by averaging its three RGB components.
    *
    * @param inPixel is a 32 bit pixel that contains RGB color values
    * @return a new Pixel in which each of the RGB components is their averaged value
    */
